...
ActiveRecord::Schema.define(:version => 20140109022301) do
  ...
  create_table "record_employments", :force => true do |t|
    t.integer  "user_id"
  ...
  add_index "record_employments", ["user_id"], :name => "index_record_employments_on_user_id"
